...
class Wikifier(object):
    ...
    def vectorize_wiki_mentions(self, mentions=(), fresh=False, filename='../workspace/vectorization.p',
        ...
        if fresh:
            ...
            print('\t+ Loading vecrtorized mentions...')
    ...
    def disambiguate_nes(self, max_documents=1000, max_words_per_doc=1000,
                         input_dir='../workspace/frog_periodicals', context_window_size=150):
        """
...
def main():
    ...
    wikifier.classifier(input_dim=input_dim, output_dim=output_dim, fresh=True, test=False, nb_epochs=1)
    ...
    wikifier.extract_unique_nes(fresh=True, max_documents=100, max_words_per_doc=150)
